...
def get_model_info(model_path):
    ...
    if "retfound_mae" in model_path.lower():
        ...
        return "dinov2_base", "dinov2_vitb14"
...
if __name__ == "__main__":
    # output_dir = "dinov3_gastro_output"
    # output_dir = "default_param_output2"
    # output_dir = "undeter_test1"
    # output_dir = "deter_test2"
    # output_dir = "our_dinov3"
    # output_dir = "test"
    # output_dir = "gastronet_dinov2_output_dir"
    # output_dir = "gastorscopy_baseline_output_dir"
    # output_dir = "our_dis_pixio"
    output_dir = "dinov2_base_output_dir"
